...
function(vcpkg_apply_patches)
    ...
    set(PATCHNUM 0)
    message(STATUS "Patching: ${_ap_SOURCE_PATH}")
    foreach(PATCH ${_ap_PATCHES})
        get_filename_component(ABSOLUTE_PATCH "${PATCH}" ABSOLUTE)
        get_filename_component(ABSOLUTE_WD "${_ap_SOURCE_PATH}" ABSOLUTE)
        message(STATUS "Applying patch ${ABSOLUTE_PATCH}")
